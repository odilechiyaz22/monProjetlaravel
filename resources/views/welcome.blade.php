        ...
        <div class="az-header-menu">
          ...
          <ul class="nav">
            <li class="nav-item active show">
              <a href="index.html" class="nav-link"><i class="typcn typcn-chart-area-outline"></i>Accueil</a>
            </li>
    
            <li class="nav-item">
              <a href="form-elements.html" class="nav-link"><i class="typcn typcn-chart-bar-outline"></i>Nouvel enregistrement</a>
            </li>
          </ul>
        </div><!-- az-header-menu -->
